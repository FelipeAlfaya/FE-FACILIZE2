...
import { ServiceModal } from '../schedule/components/service-modal'
import {
  Card,
  CardContent,
  CardDescription,
    ...
    <div className='container mx-auto py-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Visualize, adicione, edite ou exclua os serviços oferecidos.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
      ...
      <ServiceModal
        ...
        defaultValues={
          currentService || {
            ...
            price: 0,
            duration: 30,
            providerId: 0, // Este valor agora é ignorado pelo backend
          }
        }
      />
