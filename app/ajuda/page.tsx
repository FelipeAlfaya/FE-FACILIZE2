...
import { HelpCircle, Search, Book, MessageSquare, Video, FileText } from "lucide-react"
...
export default function Ajuda() {
  const helpCategories = [
    ...
    },
    {
      ...
      description: "Assista a vídeos explicativos sobre todas as funcionalidades",
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <AnimatedSection>
            <h2 className="text-2xl font-bold text-center mb-12">
              Categorias de <span className="text-blue-600 dark:text-blue-400">Ajuda</span>
            </h2>
          </AnimatedSection>
      ...
      <section className="py-12 px-4 md:px-8 max-w-4xl mx-auto">
        <AnimatedSection>
          <h2 className="text-2xl font-bold mb-8">
            Perguntas <span className="text-purple-600 dark:text-purple-400">Frequentes</span>
          </h2>
        </AnimatedSection>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
              Nossa equipe de suporte está pronta para ajudar você com qualquer dúvida ou problema que possa ter.
            </p>
