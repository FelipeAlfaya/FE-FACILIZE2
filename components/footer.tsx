      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 border-b border-gray-800">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-400">Assine nossa newsletter e receba dicas, novidades e ofertas exclusivas.</p>
            </div>
            <div>
        ...
        <div className="py-12 grid md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <Logo color="white" />
              <span className="text-xl font-bold">Facilize</span>
            </div>
            <p className="text-gray-400 text-sm">
              Simplificando a gestão de negócios para empreendedores e profissionais autônomos desde 2018.
            </p>
        ...
        <div className="py-6 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} Facilize. Todos os direitos reservados.
          </div>
          <div className="flex gap-6 text-sm">
            <Link href="/termos" className="text-gray-400 hover:text-white transition-colors duration-300">
              Termos de Uso
            </Link>
            <Link href="/privacidade" className="text-gray-400 hover:text-white transition-colors duration-300">
