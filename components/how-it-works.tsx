  ...
  const steps = [
    {
      ...
      description: "Gere notas fiscais em segundos, em conformidade com a legislação brasileira.",
    },
    {
      icon: <Calendar className="h-8 w-8 text-purple-600" />,
      title: "Gerencie agendamentos",
      description: "Organize sua agenda e envie lembretes automáticos para seus clientes.",
    },
    {
      icon: <MessageSquare className="h-8 w-8 text-green-600" />,
      title: "Automatize atendimento",
      description: "Use nosso chatbot integrado ao WhatsApp para responder perguntas frequentes.",
    },
    {
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-12">
          ...
          >
            Uma plataforma completa para simplificar a gestão do seu negócio em apenas 4 passos
          </motion.p>
        </div>
